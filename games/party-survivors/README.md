...
- Obtížnost roste **nekonečnou progresí tierů** (nový tier každých ~70 s) a pravidelnými **bossy**. Balanc cílí na to, aby hra byla ve **~13. minutě už velmi obtížná** (jako originál VS) — smrt je nevyhnutelná, jde o čas.
